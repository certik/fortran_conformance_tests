"""Regression checks for the Clause 12.5.6.12-.18 OPEN specifier fixture packet."""
...
import generate_io_open_specifiers_12_5_6_12_fixtures as generated


class IoOpenSpecifiers125612FixturesTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_exact_owned_fixture_set_and_metadata(self):
        ...
        self.assertEqual(len(self.specs), 25)
        self.assertEqual(sum(len(spec["facets"]) for spec in self.specs.values()), 25)
        ...
        for section in generated.CATALOGUES:
            ...
            for req in catalogue["requirements"]:
                ...
                if covered.get(req["id"]):
                    self.assertIn("OPEN specifier 12.5.6.12 fixture implementation:", req["oracle"])
