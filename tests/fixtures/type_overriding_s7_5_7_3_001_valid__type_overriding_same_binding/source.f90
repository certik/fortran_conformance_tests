...
call expect_value('parent-helper',dispatch(base),11)
call expect_value('child-helper',dispatch(extended),22)
call expect_value('explicit-parent',extended%parent%work(),11)
call expect_value('child-direct',extended%work(),22)
contains
