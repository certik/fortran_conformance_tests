program i169i_erfc_scaled_result_characteristics
  implicit none
  ...
  write(*,'(a)') 'INTRINSICS 16.9.I ERFC SCALED RESULT CHARACTERISTICS OK'
contains
...
end program i169i_erfc_scaled_result_characteristics
