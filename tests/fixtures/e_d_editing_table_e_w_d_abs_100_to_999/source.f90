program ede_table_e_w_d_abs_100_to_999
  implicit none
! rule: S13.7.2.3.3-005
! covers: table13_1_E_w_d_abs_100_to_999
  integer :: checks
  real :: value
  ...
  value = 1.0
  field = '##############################################################################################################'
  write(field,'(SS,101P,E110.101)') value
  ...
  if (checks /= 3) then
    write(*,'(a)') 'EDE:table_e_w_d_abs_100_to_999:check-total'
    error stop 1
  end if
  write(*,'(a)') 'E D EDITING TABLE E W D ABS 100 TO 999 OK'
contains
...
end program ede_table_e_w_d_abs_100_to_999
