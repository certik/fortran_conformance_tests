...
contains
impure elemental subroutine finish_each(self)
type(item), intent(inout) :: self
call record_event(10,self%token)
end subroutine finish_each
...
! checkpoint: elemental-after-call
call expect_log([10,20,10,20],[17,17,19,19])
call expect_before(10,17,20,17)
call expect_before(10,19,20,19)
...
! checkpoint: elemental-cleanup
call expect_log([10,20,10,20,30,31,31],[17,17,19,19,2,31,37])
call expect_before(10,17,20,17)
call expect_before(10,19,20,19)
end program p
