program ede_table_e0_or_e0_d
  implicit none
! rule: S13.7.2.3.3-005
! covers: table13_1_E_E0_or_E0_d
  integer :: checks
  real :: value
  ...
  if (checks /= 1) then
    write(*,'(a)') 'EDE:table_e0_or_e0_d:check-total'
    error stop 1
  end if
  write(*,'(a)') 'E D EDITING TABLE E0 OR E0 D OK'
contains
...
end program ede_table_e0_or_e0_d
