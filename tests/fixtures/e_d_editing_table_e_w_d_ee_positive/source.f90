program ede_table_e_w_d_ee_positive
  implicit none
! rule: S13.7.2.3.3-005
! covers: table13_1_E_w_d_Ee_positive
  integer :: checks
  real :: value
  ...
  value = 0.5
  field = '##########'
  write(field,'(SS,2P,E10.3E2)') value
  call expect_text(field, ' 50.00E-02', 'field')
  if (checks /= 1) then
    write(*,'(a)') 'EDE:table_e_w_d_ee_positive:check-total'
    error stop 1
  end if
  write(*,'(a)') 'E D EDITING TABLE E W D EE POSITIVE OK'
contains
...
end program ede_table_e_w_d_ee_positive
