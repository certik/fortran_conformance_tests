# Fortran 2023 B.3.9: ENTRY statements

The canonical catalogue is `doc/catalogues/annex_b_entry_statements_b_3_9.json`. This source packet records source accounting only; Annex B is informative in J3/24-007.
