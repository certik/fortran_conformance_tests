# Fortran 2023 B.3.7: Fixed form source

The canonical catalogue is `doc/catalogues/annex_b_fixed_form_source_b_3_7.json`. This source packet records source accounting only; Annex B is informative in J3/24-007.
