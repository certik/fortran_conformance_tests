# Fortran 2023 B.3.4: Statement functions

The canonical catalogue is `doc/catalogues/annex_b_statement_functions_b_3_4.json`. This source packet records source accounting only; Annex B is informative in J3/24-007.
