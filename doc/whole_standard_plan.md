...
## Batch 260 — Informative Annexes A-B.3.13
...
## Batch 263 — Annex C notes C.10.2.3-C.11.6
...
## Batch 269 — Procedure concept and class fixtures 15.1-15.3.2.2
...
## Batch 298 — Intrinsic fixtures 16.9.109-16.9.113 (INDEX-ISHFT)

17 programs, 37 facets and six LFortran defects.
See `doc/source_audits/batch_298.json`.

## Batch 299 — OPEN specifier fixtures 12.5.6.3-12.5.6.11
...
## Batch 308 — Procedure reference syntax fixtures 15.5.1
